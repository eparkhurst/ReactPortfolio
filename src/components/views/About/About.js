    ...
    return <div>
      ...
      <div className="about-panel">
        ...
        <p>
          ...
          an emphasis on the front end. Im currently working in Angular 6 with a Python/Flask/Postgres backend but I
          have worked with React and Node in the Past. My current project also involves NLP and some Machine learning.
